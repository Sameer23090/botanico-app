        ...
        <div style={{ minHeight: '100vh', background: 'var(--night)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', position: 'relative' }}>
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} style={{ width: '100%', maxWidth: 480, position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 36 }}>
                    ...
                    <p style={{ fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: '0.3em', color: 'var(--jade)', textTransform: 'uppercase', opacity: 0.7 }}>Create your grower profile</p>
                </div>
                ...
                <div style={{ display: 'flex', background: 'rgba(255,255,255,0.04)', borderRadius: 16, padding: 6, marginBottom: 28, border: '1px solid rgba(255,255,255,0.07)' }}>
                    <Link to="/login" style={{ flex: 1, padding: '12px', borderRadius: 12, textAlign: 'center', color: 'rgba(240,253,244,0.4)', fontSize: 14, textDecoration: 'none', fontFamily: "var(--font-body)" }}>Sign In</Link>
                    <Link to="/register" style={{ flex: 1, padding: '12px', borderRadius: 12, textAlign: 'center', background: 'linear-gradient(135deg, var(--jade), var(--emerald))', color: '#fff', fontSize: 14, fontWeight: 500, textDecoration: 'none', boxShadow: '0 4px 20px rgba(34,197,94,0.3)', fontFamily: "var(--font-body)" }}>New Grower</Link>
                </div>

                {/* Card */}
                <div className="card" style={{ padding: '44px 40px' }}>
                    <h2 style={{ fontFamily: "var(--font-serif)", fontSize: 28, fontWeight: 700, color: 'var(--pearl)', marginBottom: 4, letterSpacing: '-0.02em' }}>Join Botanico</h2>
                    <p style={{ fontSize: 14, color: 'rgba(240,253,244,0.45)', marginBottom: 32, fontWeight: 300 }}>Create your grower profile — start tracking today</p>
                    ...
                    <div style={{ textAlign: 'center', marginTop: 24 }}>
                        <Link to="/login" style={{ fontSize: 13, color: 'var(--jade)', textDecoration: 'none', fontWeight: 500 }}>Already growing? Sign in →</Link>
                    </div>
                </div>
            </motion.div>
        </div>
